...
def astolfi_controller(state, goal, kr= 0.2 , ka=  0.4 , goal_tolerance=20):
    ...
    theta = state[2]
    x_goal, y_goal = goal
    y_goal = -y_goal #Inversing signs of the y-corrdinates because of camera dataframe being inversed 
    dx = x_goal - x
    dy = y_goal - y
...
def move_to_waypoint(state, waypoint, goal_tolerance=20):
    ...
    return left_speed, right_speed, False , v_f , omega_f  #in Thymio's units + clipped control inputs in mm/s and rad/S
